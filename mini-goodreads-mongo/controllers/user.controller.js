...
showProfile = async (req, res) => {
    try {
        const profileData = await userModel.findOne({username: req.session.user.username}).exec()
        const reviewData = await reviewModel.find({username: req.session.user.username}).exec()
